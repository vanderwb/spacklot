...
# up so that it can be used within a cluster template by Spacklot
# deployment scripts.
#
...
tmproot = os.environ["SPACKLOT_TMPROOT"]
deployment = "{}/{}".format(os.environ["SPACKLOT_CLUSTER"], os.environ["SPACKLOT_CLUSTER_VERSION"])
