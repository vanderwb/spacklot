...
local wrapper_path = os.getenv("COMPILER_WRAPPER_MPI_PATH")
...
local compiler_env = os.getenv("HPC_BUILD_ENV_COMPILER")
pushenv("HPC_BUILD_ENV", compiler_env .. "-{{ spec.name }}-{{ spec.version }}")
